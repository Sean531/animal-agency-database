...
CREATE TABLE `adopter` (
  ...
  CONSTRAINT `fk_adopter_person` FOREIGN KEY (`person_id`) REFERENCES `person` (`person_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `adopter` VALUES (3,1,'Cat'),(4,0,'Dog');

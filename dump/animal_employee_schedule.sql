...
CREATE TABLE `employee_schedule` (
  ...
  `shift_length` tinyint unsigned NOT NULL,
  PRIMARY KEY (`person_id`,`start_time`),
  CONSTRAINT `fk_employee_schedule_employee` FOREIGN KEY (`person_id`) REFERENCES `employee` (`person_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `employee_schedule` VALUES (1,'2023-11-01 09:00:00',8),(2,'2023-11-01 13:00:00',8);
